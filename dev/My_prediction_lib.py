...
def calculate_prediction(data_train, header_train, data_test, header_test, col_answer, col_variables):
	#Make sure the answer will end in column 0 in the data_buff
	buff = col_answer + col_variables
	data_train_buff, header_train_buff = data_setter(data, header, buff, buff, buff)
